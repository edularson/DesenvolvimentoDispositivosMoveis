...
class _PlayerInfoPageState extends State<PlayerInfoPage> {
  ...
  final FirestoreService _firestoreService =
      FirestoreService(); // instancia do Firestore
  ...
  void _navigateToEditPage() async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => PlayerPage(player: _player)),
    );
    ...
    showDialog(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: Text(
            "Tem certeza que deseja excluir o jogador ${_player.name}?",
          ),
          actions: <Widget>[
            TextButton(
              child: const Text(
            ...
            TextButton(
              ...
              onPressed: () async {
                await _firestoreService.deletePlayer(_player.id!);
                if (mounted) {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoTile(
                ...
                title: "Nacionalidade",
                subtitle: _player.nationality,
              ),
              _buildInfoTile(
                icon: Icons.accessibility_new,
                title: "Pé Dominante",
                subtitle: _player.dominantFoot,
              ),
              _buildInfoTile(
                icon: Icons.trending_up,
                title: "Valor de Mercado",
                subtitle: _player.marketValue,
              ),
            ],
          ),
        ),
  ...
  Widget _buildStatsGrid() {
    return GridView.count(
      ...
      children: [
        _buildStatItem(Icons.person, "Idade", _player.age.toString()),
        _buildStatItem(Icons.shield, "Clube", _player.club),
        _buildStatItem(Icons.numbers, "Camisa", _player.shirtNumber.toString()),
        _buildStatItem(
          Icons.group,
          "Overall",
          _calculateOverall(_player).toString(),
        ),
      ],
    );
  }
